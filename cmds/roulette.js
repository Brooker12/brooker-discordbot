...
.setColor("#FFFFFF")
.setDescription(`🚫 | Specify the amount to be wagered | a.roulette <color> <amount>`);
...
.setColor("#FFFFFF")
.setDescription(`🚫 | Specify color| Red [1.5x] Black [2x] Green [15x]`);
    ...
    if (random == 0 && colour == 2) { // Green
        ...
        .setColor("#FFFFFF")
        .setDescription(`🎉 | You win ${money} coins\n\nMultiplier: 15x`);
        ...
        .setColor("#FFFFFF")
        .setDescription(`💸 | You Lose ${money} coins\n\nMultiplier: 0x`);
  ...
  module.exports.help = {
    name: "roulette",
    description: "gambling a ball droped",
    category: "Economy",
